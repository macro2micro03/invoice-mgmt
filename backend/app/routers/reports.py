...
async def create_material_inspection_report(
    ...
    sender: str = Form(...),
    receiver: str = Form(...),
    checklist_sender: str = Form(...),
    checklist_supervisor: str = Form(...),
    ...
    photo_set_6_top: List[UploadFile] = File(default=[]),
    photo_set_6_bottom: List[UploadFile] = File(default=[]),
    photo_set_7_top: List[UploadFile] = File(default=[]),
    photo_set_7_bottom: List[UploadFile] = File(default=[]),
    photo_set_8_top: List[UploadFile] = File(default=[]),
    photo_set_8_bottom: List[UploadFile] = File(default=[]),
    photo_set_9_top: List[UploadFile] = File(default=[]),
    photo_set_9_bottom: List[UploadFile] = File(default=[]),
    photo_set_10_top: List[UploadFile] = File(default=[]),
    photo_set_10_bottom: List[UploadFile] = File(default=[]),
    photo_set_11_top: List[UploadFile] = File(default=[]),
    photo_set_11_bottom: List[UploadFile] = File(default=[]),
    photo_set_12_top: List[UploadFile] = File(default=[]),
    photo_set_12_bottom: List[UploadFile] = File(default=[]),
    photo_set_13_top: List[UploadFile] = File(default=[]),
    photo_set_13_bottom: List[UploadFile] = File(default=[]),
    photo_set_14_top: List[UploadFile] = File(default=[]),
    photo_set_14_bottom: List[UploadFile] = File(default=[]),
    photo_set_15_top: List[UploadFile] = File(default=[]),
    photo_set_15_bottom: List[UploadFile] = File(default=[]),
    photo_set_16_top: List[UploadFile] = File(default=[]),
    photo_set_16_bottom: List[UploadFile] = File(default=[]),
    photo_set_17_top: List[UploadFile] = File(default=[]),
    photo_set_17_bottom: List[UploadFile] = File(default=[]),
    photo_set_18_top: List[UploadFile] = File(default=[]),
    photo_set_18_bottom: List[UploadFile] = File(default=[]),
    photo_set_19_top: List[UploadFile] = File(default=[]),
    photo_set_19_bottom: List[UploadFile] = File(default=[]),
    photo_set_20_top: List[UploadFile] = File(default=[]),
    photo_set_20_bottom: List[UploadFile] = File(default=[]),
    ...
    photo_set_fields = [
        ...
        (photo_set_6_top, photo_set_6_bottom),
        (photo_set_7_top, photo_set_7_bottom),
        (photo_set_8_top, photo_set_8_bottom),
        (photo_set_9_top, photo_set_9_bottom),
        (photo_set_10_top, photo_set_10_bottom),
        (photo_set_11_top, photo_set_11_bottom),
        (photo_set_12_top, photo_set_12_bottom),
        (photo_set_13_top, photo_set_13_bottom),
        (photo_set_14_top, photo_set_14_bottom),
        (photo_set_15_top, photo_set_15_bottom),
        (photo_set_16_top, photo_set_16_bottom),
        (photo_set_17_top, photo_set_17_bottom),
        (photo_set_18_top, photo_set_18_bottom),
        (photo_set_19_top, photo_set_19_bottom),
        (photo_set_20_top, photo_set_20_bottom),
    ]
    photo_sets = []
